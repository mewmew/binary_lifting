...
% ref: https://www.kth.se/social/group/examensarbete-vid-cs/page/litteraturstudier/
%
...
% * bakgrunden till ditt problem
% * background to your problem
% * hur andra angripit samma eller liknande problem
% * how others have approached the same or similar problem
% * metoder som du överväger att använda
% * methods you are considering using

\chapter{Prior Art in Binary Lifting}
...
\input{sections/2_literature_review/1_disassembly}
\input{sections/2_literature_review/2_binary_lifting}
\input{sections/2_literature_review/3_modelling_the_cpu}
\input{sections/2_literature_review/4_validation_of_binary_lifting}
\input{sections/2_literature_review/5_evaluation_of_output_quality}
